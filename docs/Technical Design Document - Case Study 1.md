...
##### 5.2.2.2 Platform & Runtime Domain
...
##### 5.2.2.5 Security & Identity Domain
...
##### 5.2.3.2 Platform & Runtime Domain
...
##### 5.2.3.3 Cloud Infrastructure Domain

| Module or Component                 | Hard Dependencies          | Soft Dependencies | Consumed By    |
| ----------------------------------- | -------------------------- | ----------------- | -------------- |
| *Oracle Cloud Infrastructure (OCI)* | *No relevant dependencies* |                   | All components |

##### 5.2.3.4 Operations & Governance Domain
...
##### 5.2.3.5 Security & Identity Domain
